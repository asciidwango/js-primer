...
- [2022-10-06 ミーティング · Discussion #1480 · js-primer/js-primer](https://github.com/js-primer/js-primer/discussions/1480)
...
- [fix(async): 非同期処理と同期処理の図を追加(並列) #1467 ](https://github.com/js-primer/js-primer/pull/1467)
  - https://jsprimer.net/basic/async/
- azu: Node CLIをES Modulesにして、CJSはコラムに変更
- [ fix(use-case/nodecli): ESModule対応 #1465 ](https://github.com/js-primer/js-primer/pull/1465)
...
- [ refactor: リポジトリをNode 16+/npm 8+へ変更 #1464 ](https://github.com/js-primer/js-primer/pull/1464)
...
- azu: [Node.js 16 LTSに更新する · Issue #1437 · js-primer/js-primer](https://github.com/js-primer/js-primer/issues/1437)をやる
...
- [`letではなくconstで反復処理をする` のタイトルと内容の組み合わせは意図的なものでしょうか · Issue #1288 · js-primer/js-primer](https://github.com/js-primer/js-primer/issues/1288)
- azu: これはコラムのタイトルが分かりにくいという感じ
- [`function` キーワードと関数式のうち推奨のものがあればそれを、ない場合はその旨明記してほしい · Issue #1354 · js-primer/js-primer](https://github.com/js-primer/js-primer/issues/1354)
- azu: これは推奨はどっち? というやつ。
- azu: これはちょっと置いておくかも
- [falsyな値の一覧の不足 · Issue #1378 · js-primer/js-primer](https://github.com/js-primer/js-primer/issues/1378)
...
- laco: 週末にちょっと直してみます
- [ECMAScript: ECMA262のURL変更 · Issue #1479 · js-primer/js-primer](https://github.com/js-primer/js-primer/issues/1479)
- azu: これは `.es` ドメインが公式なのでそっちにしようという話
- azu: `.io` で学んだなので こういうドメインはやめて欲しかった
- azu: 変更するだけ
- [Array#sliceの説明について · Issue #1163 · js-primer/js-primer](https://github.com/js-primer/js-primer/issues/1163)
- azu: これはTableで書けるのかな?
- azu: 書面だといけます?
