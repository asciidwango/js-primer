...
\hyperlink{syntax-error-import-statement}{%
\subsubsection{\texorpdfstring{[エラー例] SyntaxError: Cannot use import statement outside a module}{[エラー例] SyntaxError: Cannot use import statement outside a module}}}\label{syntax-error-import-statement}
...
たとえば、\texttt{npm test}を実行して次のようにテスト失敗している場合のエラーメッセージを見てみましょう。
