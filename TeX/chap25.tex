...
\href{https://tools.ietf.org/html/rfc2822\#section-3.3}{RFC2822}や\href{https://ja.wikipedia.org/wiki/ISO_8601}{ISO
8601}の形式に従った文字列を渡すと、
...
代表的なライブラリとしては、\href{https://momentjs.com/}{moment.js}や\href{https://github.com/js-joda/js-joda}{js-joda}、\href{https://date-fns.org/}{date-fns}などがあります。
