...
\subsection{デフォルト引数\protect\icon{fig/es2015.eps}}\label{function-default-parameters}}
...
\subsection{Rest parameters\protect\icon{fig/es2015.eps}}\label{rest-parameters}}
...
\section[関数の引数と分割代入]{関数の引数と分割代入\protect\icon{fig/es2015.eps}}\label{function-destructuring}}
...
このような名前を持たない関数を\textbf{\textgt{匿名関数}}（または無名関数）と呼びます。
...
\subsection{Arrow Function\protect\icon{fig/es2015.eps}}\label{arrow-function}}
...
一方、コールバック関数を引数として使う関数やメソッドのことを\textbf{\textgt{高階関数}}と呼びます。
...
オブジェクトのプロパティである関数を\textbf{\textgt{メソッド}}と呼びます。
...
\subsection{メソッドの短縮記法\protect\icon{fig/es2015.eps}}\label{shorthand-for-method}}
