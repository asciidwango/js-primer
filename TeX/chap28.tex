...
International}\index{Ecma International}\footnote{\url{http://www.ecma-international.org/}}という団体によって標準化されている仕様です。 Ecma
...
Polyfillを提供するものとしては\href{https://github.com/zloirock/core-js}{core-js}\index{core-js}\footnote{\url{https://github.com/zloirock/core-js}}や\href{https://polyfill.io/v2/docs/}{polyfill.io}\index{polyfill.io}\footnote{\url{https://polyfill.io/v2/docs/}}などが有名です。
