...
この書籍では\texttt{Object.prototype.toString}のようなプロトタイプメソッドを\texttt{Object\#toString}\index{Object\#toString@\texttt{Object\#toString}}と短縮して表記します。
...
\texttt{hasOwnProperty}\index{hasOwnProperty@\texttt{hasOwnProperty}}メソッドは、そのオブジェクト自身が指定したプロパティを持っているかを判定します。
...
たとえば、\texttt{Array\#toString}\index{Array\#toString@\texttt{Array\#toString}}メソッドもそのひとつです。
...
\begin{tcolorbox}[enhanced jigsaw,breakable,title=\texttt{Object.prototype}を継承しないオブジェクト]\label{not-inherit-object}}\index{Object.prototype@\texttt{Object.prototype}}\index{Object.prototype@\texttt{Object.prototype}!けいしょうしない@継承しない}
