...
この書籍の「\href{../README.md}{第一部:
基本文法}」ではECMAScriptの定義する構文やオブジェクトを学んでいきます。
「\href{../../use-case/README.md}{第二部:
応用編（ユースケース）}」ではブラウザやNode.jsといった実行環境が定義するオブジェクトを学びながら、小さなアプリケーションを作成していきます。
