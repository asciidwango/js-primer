...
\chapter[Map/Set]{Map/Set\,\protect\icon{fig/es2015.eps}}\label{map-and-set}}\index{Map}\index{Set}
...
\subsection{マップとしてのObjectとMap}\label{object-and-map}}\index{まっぷ@マップ!Object}\index{Object}\index{Map}
...
\begin{tcolorbox}[float,title=キーの等価性とNaN]\label{key-and-nan}\index{NaN}
...
\hypertarget{set}{%
\section{Set}\label{set}}\index{Set}
...
\hypertarget{set-new}{%
\section{セットの作成と初期化}\label{set-new}}\index{せっと@セット!さくせい@作成}
