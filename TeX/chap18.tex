...
\begin{tcolorbox}[title=動的スコープ]\label{dynamic-scope}\index{どうてきすこーぷ@動的スコープ}
...
\begin{tcolorbox}[title=状態を持つ関数オブジェクト]\label{closure-vs-function-object}\index{じょうたい@状態}\index{かんすうおぶじぇくと@関数オブジェクト}
