...
関数における\texttt{this}の基本的な参照先（暗黙的に関数に渡す\texttt{this}の値）は\textbf{\textgt{ベースオブジェクト}}となります。
...
そのため、メソッドではない通常の関数においては\texttt{this}を使うべきではありません\footnote{ES2015の仕様編集者であるAllen Wirfs-Brock‏氏もただの関数においては\texttt{this}を使うべきではないと述べている。\url{https://twitter.com/awbjs/status/938272440085446657}}。
