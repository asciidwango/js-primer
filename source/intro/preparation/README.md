...
この書籍には、すでに何かしらのプログラミング言語を触ったことがある人向けの内容も含まれています。
...
このサンプルコードを、次のエディタに書き写して"実行"ボタンをおして、JavaScriptを実行してみてください。
...
そのため、書籍より情報量の多い動画などを見て、まずはコードを実行できるようにすることから始めるのがよいかもしれません。
