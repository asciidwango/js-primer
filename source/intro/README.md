...
JavaScriptは、2015年にECMAScript 2015と呼ばれる仕様の大きな変更が入りました。
...
そのため、JavaScriptの熟練者であっても、この書籍を読むことでの発見はあるはずです。

## 本書の特徴 {#features}

この書籍の特徴について簡単に紹介します。

JavaScriptは、2015年にECMAScript 2015と呼ばれる仕様の大きな更新が行われました。
...
しかし、現実のコードでは古い書き方への理解も必要になるため、頻出するケースには紹介しています。
