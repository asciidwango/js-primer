...
Ecma InternationalやECMAScript以外にもC#やDartなどの標準化作業を行っている団体です。
...
プロポーザルのステージは2ヶ月に1度行われるTC39のミーティングにおいて、プロポーザルごとにステージを進めるかどうかを議論します。
このミーティングの議事録もGitHub上の[tc39/tc39-notes][]にて公開されています。
そして、Stage 4となったプロポーザルはドラフト版である[tc39/ecma262][]へマージされ、そして毎年の決まった時期に`ECMAScript 20XX`としてリリースします。
...
そのため、使い方を覚えたいなど通常の範囲では、ECMAScriptの仕様そのものを参照する機会は少ないでしょう。
