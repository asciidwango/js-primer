...
たとえば、`1` という数値に対して `-1` という数値を符号付き32ビット整数は次のように2の補数で求められます。
...
これによって、`-1`は符号付き32ビット整数では `1111_1111_1111_1111_1111_1111_1111_1111` となります。

![-1の符号付き32ビット整数での表現](./img/1111_1111_1111_1111_1111_1111_1111_1111.png)

<!-- textlint-disable ja-technical-writing/sentence-length -->

そのため符号付き32ビット整数で表現できる数値の範囲は`-2147483648`（`1111_1111_1111_1111_1111_1111_1111_1111`）から`2147483647`（`0111_1111_1111_1111_1111_1111_1111_1111` ）までとなります。
