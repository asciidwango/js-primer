...
プリミティブ型（基本型）は名前のとおり、真偽値や数値などの基本的な値の型のことです。
...
また、オブジェクトの中でもよく利用されるもの関してはリテラル表現が用意されています。

- オブジェクト
- 配列
- 正規表現

これらのリテラルについて順番に見ていきます。
...
- 真偽値、数値、文字列、nullはリテラル表現がある
- オブジェクトの中でも、オブジェクト、配列、正規表現にはリテラル表現がある
